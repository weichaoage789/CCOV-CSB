...
/*停车点信息结构 ---  4个*/
/*停车点属性定义 add by sds 2019-10-22 增加2编组、7编组、上行方向、下行方向、洗车暂停、退出洗车等停车点宏*/
...
#define EMAP_2GROUP_STOP_POINT 0x100000         /*2编组停车点*/
#define EMAP_7GROUP_STOP_POINT 0x200000         /*7编组停车点*/
#define EMAP_UPDIRECTION_STOP_POINT 0x2000      /*上行方向停车点*/
#define EMAP_DOWNDIRECTION_STOP_POINT 0x4000    /*下行方向停车点*/
#define EMAP_CLEANPAUSE_STOP_POINT 0x10000      /*洗车暂停停车点*/
#define EMAP_EXITCLEAN_STOP_POINT 0x80000       /*退出洗车停车点*/
