...
extern "C" {
	...
	typedef struct {
		...
		UINT16 FactoryCodeOfCRSC;               /*互联互通厂家代码中"通号"所属编号，add by sds 2020-02-12*/
		UINT16 FactoryCodeOfTCT;                /*互联互通厂家代码中"交控科技"所属编号”类型，add by sds 2020-02-12*/
		UINT16 FactoryCodeOfTK;                 /*互联互通厂家代码中"铁科"所属编号”类型，add by sds 2020-02-12*/
		UINT16 FactoryCodeOfZH;                 /*互联互通厂家代码中"众合"所属编号，add by sds 2020-02-12*/
		UINT32 CommFaultTimeOfPSC_CI;           /*PSC-CI通信故障判断时间(ms)  互联互通数据结构V20.0.0*/
		UINT32 CommFaultTimeOfPSC_VOBC;         /*PSC-VOBC通信故障判断时间(ms)  互联互通数据结构V20.0.0*/
		UINT32 CommFaultTimeOfPSC_IM;           /*PSC-IM通信故障判断时间(ms)  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolTypeOfVOBC_PSC;       /*VOBC-PSC接口协议类型  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolVerOfVOBC_PSC;        /*VOBC-PSC接口协议版本号  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolTypeOfVOBC_MSS;       /*VOBC与MSS通信时使用接口协议类型  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolTypeOfVOBC_CI;        /*VOBC与CI通信时使用接口协议类型  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolTypeOfVOBC_ZC;        /*VOBC与ZC通信时使用接口协议类型  互联互通数据结构V20.0.0*/
		UINT8 CommProtocolTypeOfVOBC_ATS;       /*VOBC与ATS通信时使用接口协议类型  互联互通数据结构V20.0.0*/
