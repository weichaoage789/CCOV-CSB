...
/*电子地图各数据ID*/
#define EMAP_NOP_0					0	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
...
#define EMAP_NOP_40					40	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_POWERLESSZONE_ID		41	/*分相区表ID，依据互联互通数据结构V12.0.0添加，add by lmy 20180312*/
#define EMAP_NOP_42					42	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_43					43	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_44					44	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_45					45	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_46					46	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_47					47	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_48					48	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_49					49	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_50					50	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_CARSTOP_ID				51  /*车档表ID，依据互联互通数据结构V15.0.0添加，add by sds 20181031*/
#define EMAP_ADJTSTATION_ID         52  /*临线停车区域ID，依据互联互通数据结构V15.1.2添加，add by mbb 20190807*/
#define EMAP_PSC_ID					53	/*PSC表ID*/
#define EMAP_NOP_54					54	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_55					55	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_56					56	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_57					57	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_58					58	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_59					59	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_60					60	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_61					61	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_62					62	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_63					63	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_64					64	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_65					65	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_66					66	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_67					67	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_68					68	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_69					69	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_70					70	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_71					71	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_72					72	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_73					73	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_74					74	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_75					75	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_76					76	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_77					77	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_78					78	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_79					79	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
#define EMAP_NOP_80					80	/*为实现数据表与实际表数值一一对应，所以从0开始 补全数据 ID  tqf*/
...
#define  VOBC_RAIL_INFO_ID            1          /*ATP/ATO公共配置线路参数*/
#define  VOBC_TRAIN_INFO_ID           2          /*ATP/ATO公共配置车辆参数*/
#define  VOBC_ACC_TABLE_ID            3          /*最大牵引加速度分段取值表*/
...
#define  VOBC_FUNC_CONFIG_DATA        6          /*ATP及ATO公共配置功能表 针对互联互通数据结构V18.0.0 add by sds 20200522*/
...
#define  VOBC_ATP_TRAIN_CONFIGDATA_ID                    1         /*ATP车辆参数表*/
#define  VOBC_ATP_SECURITY_CONFIGDATA_ID                 2         /*ATP工程安全防护参数*/
#define  VOBC_ATP_FUNC_CONFIGDATA_ID                     3         /*ATP功能配置表 针对互联互通数据结构V18.0.0 add by sds 20200522*/
#define  VOBC_ATP_PRODUCT_SECURITY_CONFIGDATA_ID         4         /*ATP产品安全防护参数 针对互联互通数据结构V18.0.0 add by sds 20200522*/
...
#define  VOBC_ATO_PROJECT_CONFIGDATA_ID      1              /*ATO工程参数配置表*/
...
#define  VOBC_ATO_PRODUCT_CONFIGDATA_ID      5              /*ATO产品参数配置表*/
#define  VOBC_ATO_FUNC_CONFIGDATA_ID         6              /*ATO配置功能表 针对互联互通数据结构V18.0.0 add by sds 20200522*/
