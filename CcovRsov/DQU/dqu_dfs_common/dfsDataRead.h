...
#define  DFS_MAX_FILE_LEN        ((UINT32)(3*1024*1024))   /*最大支持的文件长度（3M）*/

#define  DFS_DH_SPARE_BYTE_LENGTH  20                        /*预留字节长度*/
#define  DFS_DI_SPARE_BYTE_LENGTH  8                         /*预留字节长度*/
#define  DATA_CONTENT_MALLOC_SIZE (0x300000)               /*FS数据开辟空间最大限制*/  
/*文件读取失败错误码*/
...
/*函数执行错误码*/
#define DSU_FUNC_SUCESS		(0x00000000)
#define DSU_FUNC_CODE1		(0x00000001)
#define DSU_FUNC_CODE2		(0x00000002)
#define DSU_FUNC_CODE3		(0x00000004)
#define DSU_FUNC_CODE4		(0x00000008)
#define DSU_FUNC_CODE5		(0x00000010)
#define DSU_FUNC_CODE6		(0x00000020)
#define DSU_FUNC_CODE7		(0x00000040)
#define DSU_FUNC_CODE8		(0x00000080)
#define DSU_FUNC_CODE9		(0x00000100)
#define DSU_FUNC_CODE10		(0x00000200)
#define DSU_FUNC_CODE11		(0x00000400)
#define DSU_FUNC_CODE12		(0x00000800)
#define DSU_FUNC_CODE13		(0x00001000)
#define DSU_FUNC_CODE14		(0x00002000)
#define DSU_FUNC_CODE15		(0x00004000)
#define DSU_FUNC_CODE16		(0x00008000)
...
/*函数功能：读取二进制文件，解析FS数据头，并设置查询函数的版本类型(无内存分配操作)*/
UINT8 dataReadNoCopy(CHAR* dataName);
